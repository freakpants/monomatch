...
export default class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.text = this.add.text(this.getCenterX(), this.getCenterY() + 200, this.staticText + 'Currently ' + document.connectedPlayersAmount + " are connected.", { fontSize: "30px", align: "center", color: '#ffffff', fontFamily: 'Oswald' }).setOrigin(0.5, 0.5);
